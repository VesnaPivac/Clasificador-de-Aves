...
// // Función para obtener y manipular los datos del archivo JSON
...
function predecir() {
    if (modelo != null) {
        //Pasar canvas a version 300x300
        ...
        // obtenerClases().then(function(clasesObtenidas) {
        //     if (clasesObtenidas) {
        //         var clases = clasesObtenidas; 
        //         console.log("Lista de clases asignada a la variable clases:", clases);
        //     } else {
        //         console.error('No se pudieron obtener las clases.');
        //     }
        // });
